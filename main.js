...
(function () {
  ...
  if (quoteModal && quoteForm && quoteOpeners.length > 0) {
    ...
    var ADDON_STANDALONE_PRICE = {
      ...
      event_director:     { type: 'flat', value: 3500000 },
    ...
    quoteForm.addEventListener('submit', async function (e) {
      ...
      if (!guests || parseInt(guests, 10) < 1) {
        ...
        // Премиум багц бүх кемп дээр 100+ хүн шаардана
        if (tier === 'Премиум' && guestsNum < 100) {
          markError(errGuests, guestInput, 'Премиум багц хамгийн багадаа 100 хүнтэй байх шаардлагатай. Хүний тоогоо нэмэх эсвэл Стандарт багц сонгоно уу.');
        }
      }
